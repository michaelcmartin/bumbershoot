...
print "        defb    $3C,$21,$30,$71,$34,$0D,$38,$33,$3C,$01"
...
print "        defb    $B4,$C0,$A4,$%02X,$A0,$%02X,$28,$F0" % (notes[0] >> 8, notes[0] & 0xff)
for note in notes[1:]:
    print "        defb    $3C,$03,$A4,$%02X,$A0,$%02X,$28,$F0" % (note >> 8, note & 0xff)
print "        defb    $00"
